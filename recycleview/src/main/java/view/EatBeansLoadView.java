...
public class EatBeansLoadView extends View {
    ...
    private void init(Context context) {
        ...
        eatRadius = RecyclerUtils.dip2px(mContext,15);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //处理 wrap_content问题
        int defaultDimension = RecyclerUtils.dip2px(mContext,100);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setStrokeWidth(RecyclerUtils.dip2px(mContext,2));
        ...
        canvas.drawCircle(centerX - mRadius + eatRadius + moveX, centerY - eatRadius / 2, RecyclerUtils.dip2px(mContext,2), mPaint);
        ...
        for (int i = eatBeans; i < count; i++) {
            canvas.drawCircle(centerX - mRadius + eatRadius * 2 +
                    eatRadius * (i + 1), centerY, RecyclerUtils.dip2px(mContext,2), mPaint);
        }
