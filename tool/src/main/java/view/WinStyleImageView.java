...
/**
 * imageview的点击效果，仿win8风格
 * Created by SunySan on 2016/12/15.
 */
public class WinStyleImageView extends ImageView{
    ...
    public WinStyleImageView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        camera = new Camera();
    }

    public WinStyleImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
        camera = new Camera();
    }
